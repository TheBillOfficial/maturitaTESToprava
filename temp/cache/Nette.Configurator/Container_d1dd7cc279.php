<?php
// source: Z:\Programovani\Projekty\NETTEVinc\app/config/config.neon 
// source: Z:\Programovani\Projekty\NETTEVinc\app/config/config.local.neon 

class Container_d1dd7cc279 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Presenters\MexicanaPresenter' => [1 => ['application.4']],
		...
		'services' => [
			...
			'application.4' => 'App\Presenters\MexicanaPresenter',
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'Z:\Programovani\Projekty\NETTEVinc\app',
			'wwwDir' => 'Z:\Programovani\Projekty\NETTEVinc\www',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'Z:\Programovani\Projekty\NETTEVinc\app/../temp',
		];
	}
	...
	public function createServiceApplication__4(): App\Presenters\MexicanaPresenter
	{
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'Z:\Programovani\Projekty\NETTEVinc\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'
		));
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('Z:\Programovani\Projekty\NETTEVinc\app/../temp/cache');
		return $service;
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_d1dd7cc279 $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('Z:\Programovani\Projekty\NETTEVinc\app/../temp/cache/latte');
