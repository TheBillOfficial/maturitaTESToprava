<?php
// source: Z:\Programovani\Projekty\NETTEprg\app/config/config.neon 
// source: Z:\Programovani\Projekty\NETTEprg\app/config/config.local.neon 

class Container_8c4503f089 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'Z:\Programovani\Projekty\NETTEprg\app',
			'wwwDir' => 'Z:\Programovani\Projekty\NETTEprg\www',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'Z:\Programovani\Projekty\NETTEprg\app/../temp',
		];
	}
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'Z:\Programovani\Projekty\NETTEprg\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'
		));
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('Z:\Programovani\Projekty\NETTEprg\app/../temp/cache');
		return $service;
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_8c4503f089 $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('Z:\Programovani\Projekty\NETTEprg\app/../temp/cache/latte');
